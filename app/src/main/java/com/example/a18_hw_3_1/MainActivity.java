package com.example.a18_hw_3_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        Toast toast = Toast.makeText(this, "Старт активности", Toast.LENGTH_LONG); // инициализация
...
//    Реализуем метод сохранения onSaveInstanceState:
